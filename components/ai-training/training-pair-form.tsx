    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="space-y-1.5">
        <Label htmlFor="question" className="text-xs font-medium">
          السؤال <span className="text-destructive">*</span>
        </Label>
        <Textarea
          id="question"
        ...
        <p className="text-xs text-muted-foreground">
          تغيير السؤال سيعيد توليد التضمين الخاص به.
        </p>
      </div>

      <div className="space-y-1.5">
        <Label htmlFor="answer" className="text-xs font-medium">
          الإجابة <span className="text-destructive">*</span>
        </Label>
        <Textarea
          id="answer"
          placeholder="الرد المعتمد..."
          rows={6}
          className="resize-none text-sm"
          {...register("answer")}
        />
